...
import {useGetRevenueLast7DaysQuery} from '@/services/analytics/Analytics'
import { FaChartBar, FaChartLine } from 'react-icons/fa';



export default function RevenueBy7Days() {
  const [revenues,setRevenues] = useState([]);
  const {data,isLoading,isSuccess,refetch} = useGetRevenueLast7DaysQuery();
