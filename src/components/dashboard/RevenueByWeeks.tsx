...
import { useGetRevenueLast4WeeksQuery} from '@/services/analytics/Analytics'
import { FaChartBar, FaChartLine } from 'react-icons/fa';



export default function RevenueBy4Weeks() {
  const [revenues,setRevenues] = useState([]);
  const {data,isLoading} = useGetRevenueLast4WeeksQuery();
